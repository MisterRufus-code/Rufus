...
def _pre_analyze(client: OpenAI, seed: dict, scene: str, run_id: str,
    ...
    if is_wisdom:
        ...
        prompt = (
            ...
            "4. EMOTIONAL STAKES: One sentence — what does someone LOSE if they never understand this quote? Name it as an event with a cost, never as a feeling somebody has — the fact gate rejects a script for attributing fear, hope or regret to unnamed people, and asking for the feeling here is what produced four MIND-READ rejections in one live run.\n"
            "5. HOOK ANGLE: One short seed phrase (the hook gate allows up to 12 words) that leads with the BIOGRAPHICAL FACT — not the quote text.\n"
        ...
        prompt = (
            ...
            "2. HOOK ANGLE: One short seed phrase (the hook gate allows up to 12 words). Lead with the number/name/surprise — not the headline.\n"
            "3. HUMAN ANGLE: Who is affected and how? One sentence with a specific person, company, or group.\n"
            "4. EMOTIONAL STAKES: What does the average viewer LOSE or GAIN from this story? One sentence. Name it as an event with a cost, never as a feeling somebody has — the fact gate rejects a script for attributing fear, hope or regret to unnamed people, and asking for the feeling here is what produced four MIND-READ rejections in one live run.\n"
        ...
        prompt = (
            ...
            "2. HOOK ANGLE: One short seed phrase (the hook gate allows up to 12 words). Lead with the number/name/contradiction. "
            ...
            "4. EMOTIONAL STAKES: One sentence — what does the average person LOSE if they ignore this insight? Name it as an event with a cost, never as a feeling somebody has — the fact gate rejects a script for attributing fear, hope or regret to unnamed people, and asking for the feeling here is what produced four MIND-READ rejections in one live run.\n"
